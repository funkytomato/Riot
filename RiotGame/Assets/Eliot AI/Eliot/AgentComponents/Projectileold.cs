...
namespace Eliot.AgentComponents
{
    ...
    public class ProjectileOld : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ThrownProjectileScript projectile = gameObject.GetComponent<ThrownProjectileScript>();

            projectile.m_Gravity = m_Gravity;
            projectile.m_CurrentVelocity = startVelocity;
