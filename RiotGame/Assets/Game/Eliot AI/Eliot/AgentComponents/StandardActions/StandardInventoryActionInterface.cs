...
namespace Eliot.AgentComponents
{
    ...
    public class StandardInventoryActionInterface : InventoryActionInterface
    {
        ...
        /// <summary>
        /// Find the best projectile in Inventory and wield it.
        /// </summary>
        ...
        /// <summary>
        /// Try to find an potion in the Inventory and use it.
        /// </summary>
        [IncludeInBehaviour]
        public void UsePotion()
        {
            ...
            {
                var item = _inventory.Items[i];
                if (item.Type == ItemType.Potion && item.Value > (bestPotion == null ? -10000 : bestPotion.Value))
                    bestPotion = item;
            }
            if (bestPotion != null)
                bestPotion.Use(_agent);
